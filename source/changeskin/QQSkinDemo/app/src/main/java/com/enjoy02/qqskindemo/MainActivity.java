...
import com.enjoy02.qqskindemo.skin.SkinEngine;
...
public class MainActivity extends Activity {
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		mBtnStart.setOnClickListener(new OnClickListener() {
			...
			public void onClick(View v) {
				SkinEngine.getInstances().init(getResources());
				SkinEngine.getInstances().addResource(getResources(), R.mipmap.ic_launcher);
	...
	private void reloadDrawable(){
		...
		mImg.setImageDrawable(getResources().getDrawable(R.mipmap.ic_launcher));
	}
